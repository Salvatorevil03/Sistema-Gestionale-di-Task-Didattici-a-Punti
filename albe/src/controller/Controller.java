...
public class Controller {
    ...
    public static int registrazione(String ruolo,String nome,String cognome, String mail, String password){
        ...
        String replacedCognome = cognome.replaceAll(QUOTES_REGEX, " ").replaceAll("\\s+", " ").trim();
        String replacedMail = mail.replaceAll(QUOTES_REGEX, " ").replaceAll("\\s+", "").trim();
        String replacedPassword = password.replaceAll(QUOTES_REGEX, " ").replaceAll("\\s+", "").trim();
        return Piattaforma.registrazione(ruolo,replacedNome,replacedCognome,replacedMail,replacedPassword);
    }
    ...
    public static int creaClasse(String nome, String pkDocente){
        ...
        if (docenteID==-1){return -1;}

        EntityDocente docente = new EntityDocente(docenteID);
        return docente.creaClasse(replacedNome);
    }
    ...
    public static List<DTOClasse> getClassi(String pkDocente){
        ...
        EntityDocente docente = new EntityDocente(docenteID);
        List<DTOClasse> dtoClassi=docente.getElencoClassi();
    ...
    public static List<DTOTask> getTasks(String pkClasse){
        ...
        EntityClasse classe = new EntityClasse(classeID);
        List<DTOTask> dtoTasks = classe.getTasks();
    ...
    public static List<DTOStudente> getStudenti(String pkClasse){
        ...
        EntityClasse classe = new EntityClasse(classeID);
        List<DTOStudente> dtoStudenti=classe.getStudenti();
    ...
    public static List<DTOConsegna> getConsegne(String pkTask){
        ...
        List<DTOConsegna> dtoConsegne=task.getConsegne();
    ...
    public static int valutaConsegna(String pkTask, String pkConsegna, int voto){
        ...
        if(taskID==-1 || consegnaID==-1){ return -1;}
    ...
    public static List<DTOStudente> getClassificaPunteggio(String pkClasse){
        ...
        EntityClasse classe = new EntityClasse(classeID);
        List<DTOStudente> lista=classe.getStudenti();
