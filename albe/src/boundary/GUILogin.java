...
public class GUILogin extends JFrame {
	...
	public GUILogin() {
		...
		titoloLogin.setFont(new Font(FONT_FAMILY, Font.BOLD, 30));
		...
		accessoBTN.setFont(new Font(FONT_FAMILY, Font.PLAIN, 15));
		...
		registrazioneBTN.setFont(new Font(FONT_FAMILY, Font.PLAIN, 15));
		...
		orLabel.setBounds(401, 461, 39, 14);
