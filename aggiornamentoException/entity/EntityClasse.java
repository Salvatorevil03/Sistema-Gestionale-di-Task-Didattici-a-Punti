...
public class EntityClasse {
     ...
     *
     * <p>Dopo le verifiche effettuate nella GUI {@link boundary.GUIClasseDocente}
     ...
     *
     */
    public void creaTask(String titolo, String descrizione, String dataScadenza, int maxPunteggio) {
    ...
    public void iscrizione(int studenteID, int classeID) {
        DBClasse classe = new DBClasse();
        try {
            classe.iscrizioneSuDB(studenteID, classeID);
        } catch (DBException e) {
